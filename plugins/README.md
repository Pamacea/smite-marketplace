# SMITE Plugin Marketplace v1.5.0

Official plugin marketplace for the Smite Code Quality & Documentation System.

## Overview

The Smite Plugin Marketplace v1.5.0 features a **unified 3-plugin architecture** with a 4-flag composable system, providing a streamlined and focused development experience.

**Key features in v1.5.0:**
- **Consolidation**: 7 plugins → 3 plugins (core, studio, essentials)
- **4-Flag System**: Speed, scale, quality, team - composable flags
- **Auto-detection**: Zero-configuration usage
- **Better integration**: All development tools in studio plugin
- **Production-ready**: Comprehensive migration path and documentation
